...
def siScore_parser():
    ...
    parser.add_argument('--batch-sz', default=2, type=int, help='batch size')
    ...
    parser.add_argument('--llm', type=str, help='o1mini o3mini o4-mini deepseek-reasoner')
    parser.add_argument('--exp_name', type=str, default='', help='experiment name, default=args.llm')
    parser.add_argument('--shot', type=str, default=None, help='shot dataframe name')
...
def extract_score_parser():
    ...
    parser.add_argument('--test', type=str, default = 'NK_FA.csv', help='test data name')
    parser.add_argument('--llm', type=str, help='o1mini o3mini o4-mini deepseek-reasoner')
    parser.add_argument('--exp_name', type=str, default='', help='experiment name, default=args.llm')
    parser.add_argument('--shot', type=str, default=None, help='shot dataframe name')
